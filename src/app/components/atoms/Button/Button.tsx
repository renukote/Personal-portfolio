...
export function Button({ onClick, children, additionalClassNames, variant }: ButtonProps) {
  const buttonClasses = clsx(
    ...
    {
      "text-primary hover:border-tertiary hover:bg-tertiary hover:text-secondary": variant === "primary",
      "border-primary bg-primary text-secondary hover:border-white hover:bg-secondary hover:text-white":
        variant === "secondary",
